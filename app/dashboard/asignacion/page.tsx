...
export default function AssignmentPage(){
  ...
  return <AppShell active="Asignación">
    ...
    {rejectModal && <AppModal onClose={closeRejectModal} dirty={Boolean(rejectNote.trim())}>
      ...
      <div style={{display:"flex",gap:12}}>
        ...
        <button className="btn red" data-modal-close>Cancelar</button>
      </div>
    </AppModal>}

    {deleteModal && <AppModal onClose={closeDeleteModal} dirty={Boolean(deleteConfirm.trim())}>
      ...
      <div style={{display:"flex",gap:12}}>
        ...
        <button className="btn" data-modal-close>Cancelar</button>
      </div>
    </AppModal>}

...
export default function TasksPage(){
  ...
  const taskDirty = Boolean(selected) && (Boolean(comment.trim()) || finalLink !== (selected?.finalPostLink || ""));
  ...
  return <AppShell active="Tareas">
    ...
    {selected && <AppModal onClose={closeTask} dirty={taskDirty} cardStyle={{width:"min(1120px,96vw)"}}>
    ...
    {contextPost && <AppModal onClose={()=>setContextPost(null)} cardStyle={{width:"min(880px,96vw)"}}>
        <div style={{display:"flex",justifyContent:"space-between",gap:12,alignItems:"start"}}>
          <div>

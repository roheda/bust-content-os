...
import { Brand, ContentRequest, ReferenceFile, contentTypes, emptyRequest, getRequestDate, listBrands, listRequests, objectives, saveRequest, saveRequestBatch, uploadReferenceFiles } from "@/lib/data";
...
export default function PlannerPage(){
  ...
  function generate(){
    ...
    const defaultBatchName = `${client.name} · Lote ${new Date().toLocaleDateString("es-MX")}`;
    if(!batchName)setBatchName(defaultBatchName);
  ...
  function validateBatch(){
    if(!proposals.length){alert("Genera propuestas primero");return false}

...
export default function PlannerPage(){
  ...
  const [manual,setManual]=useState<Piece>(emptyPiece);
  ...
  function setManual(k:keyof Piece,v:any){setManual({...manual,[k]:v})}
  ...
  async function saveManual(){
    ...
    setManual(emptyPiece);await load();alert("Solicitud manual guardada");
  }

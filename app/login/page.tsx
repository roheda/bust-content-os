  ...
  return <main className="login">
    <section className="login-card">
      <div className="login-brand">
        ...
        <p style={{color:"#cbd5e1",lineHeight:1.7}}>Creador de solicitudes, asignación, producciones y calendario operativo.</p>
      </div>
      <div className="login-form">
        <p className="eyebrow">Acceso demo</p>
        <h2 style={{fontSize:32,marginTop:0}}>Entrar al sistema</h2>
        <p style={{color:"#667085",lineHeight:1.6}}>Esta versión ya trabaja con Firestore y Storage.</p>
